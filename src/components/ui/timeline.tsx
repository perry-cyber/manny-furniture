  ...
  return (
    ...
    >
      <div className="w-full mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        Introducing Manny Production: A premier provider of bespoke furniture and upholstery solutions. We are a dynamic and innovative company that has established itself as a leader in the Nigerian furniture industry. Our commitment to excellence, quality, and customer satisfaction has earned us a reputation as a trusted partner for individuals, businesses, and organizations seeking exceptional furniture and interior design services.
        </p>
        <p className=" mt-4 text-neutral-700 dark:text-neutral-300 text-sm md:text-base w-full">
