"use client"
import CommunitySection from '@/components/comSec';
import FloatingNavbar from '@/components/FloatingNav'
import CarouselDemo from '@/components/Precatelog';
...
<TimelineDemo/>
    ...
    <CarouselDemo/>
    <div>
      <h1 className="text-left pl-10 text-white text-4xl font-bold my-10">Customers Reviews</h1>
      <ReviewSlider />
    </div>
